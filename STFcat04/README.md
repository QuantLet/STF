...
## [<img src="https://github.com/QuantLet/Styleguide-and-Validation-procedure/blob/master/pictures/qloqo.png" alt="Visit QuantNet">](http://quantlet.de/) **STFcat04** [<img src="https://github.com/QuantLet/Styleguide-and-Validation-procedure/blob/master/pictures/QN2.png" width="60" alt="Visit QuantNet 2.0">](http://quantlet.de/d3/ia)
...
Description : 'Plots the zero-coupon CAT bond price for the Burr claim amounts and the
...
Example : '3D plot of the zero-coupon CAT bond price for the Burr claim amounts and the
non-homogeneous Poisson process governing the flow of losses.'
...
wireframe(z ~ x + y, data = data, screen = list(z = 50, x = -60), drape = TRUE, colorkey = F, ticktype = "detailed", scales = list(arrows = FALSE, 
